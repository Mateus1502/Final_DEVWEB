...
app.get("/cadastrar", (_req, res) => {
  res.sendFile(__dirname + "/static/html/cadastrar.html");
});
app.get("/cadastrar.js", (_req, res) => {
  res.sendFile(__dirname + "/static/js/cadastrar.js");
});
app.get("/editar", (_req, res) => {
  res.sendFile(__dirname + "/static/html/editar.html");
});
app.get("/editar.js", (_req, res) => {
  res.sendFile(__dirname + "/static/js/editar.js");
});
...
app.get("/deletar.js", (_req, res) => {
  res.sendFile(__dirname + "/static/js/deletar.js");
});
app.listen(port, () => {
